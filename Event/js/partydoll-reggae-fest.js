const SCRIPT_URL = "https://script.google.com/macros/s/AKfycby7aRsnDEY-w9rdrxFQsr4zPOEcEkc6bSkXcldaRfAFocWIda4M0NhKFbumVkAUlGDt/exec";
const CLOUDINARY_URL = "https://api.cloudinary.com/v1_1/dn4ugx6ar/upload";
const UPLOAD_PRESET = "partydoll-reggaefest";
...
plus.onclick = () => { if (qty < 3) { qty++; updateQty(); } };
